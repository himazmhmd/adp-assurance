...
if (typeof netreviewsWidget04 === "undefined") {
    netreviewsWidget04 = {
        create: function () {
            return {
                widgetID: "",
                ...
                scale: 0,
                html:
                    '<div id="#id#widget04av"><div id="#id#widget04avBackground"><img id="#id#widget04avImage" src="https://cl.avis-verifies.com/fr/widget4/widget04.png" /><div id="#id#widget04avStars01"></div><div id="#id#widget04avStars02"></div><div id="#id#widget04avStars03"></div><div id="#id#widget04avStars04"></div><div id="#id#widget04avStars05"></div><div id="#id#widget04avStars06"></div><div id="#id#widget04avRateWrap"><span id="#id#widget04avRate"></span>/<span id="#id#widget04avRateOver"></span></div></div></div>',
                background: {
                    position: "relative",
                    width: "475px",
                    height: "186px",
                ...
                imageFull: '<img alt="orange star" style="width: 33px;height: 33px;max-width: 33px;max-height: 33px;" src="https://cl.avis-verifies.com/fr/widget4/etoile_orange_full.png" />',
                imageEmpty: '<img alt="black star" style="width: 33px;height: 33px;max-width: 33px;max-height: 33px;" src="https://cl.avis-verifies.com/fr/widget4/etoile_orange_empty.png" />',
                star01: {
                    left: "137px",
                },
                star02: {
                ...
                fillEmptyStar: function (i) {
                    var $ = this.jQuery;
                    var selector = this.selectorID("widget04avStars0" + i);
                ...
                _generateWidget_: function (widgetCSS) {
                    ...
                    var $widget04 = $tmp.children();
                    // add widget to body
                    // check if fixed or not
                    if (widgetCSS.position && widgetCSS.position == "fixed") {
                        $("body").append($tmp);
                        $widget04.css("z-index", "99999");
                        $("#" + this.widgetID).remove();
                    } else {
                        $("#" + this.widgetID).replaceWith($tmp);
                        $tmp.css("display", "inline-block");
                        $tmp.css("position", "relative");
                        $widget04.css("position", "absolute");
                        addDimension = true;
                    }

                    $widget04.css(widgetCSS);

                    $widget04.find(this.selectorID("widget04avBackground")).css(this.background);
                    // for ie8,ie7
                    if (this.IESniff() < 9) {
                        $widget04.css("zoom", this.scale);
                        $widget04.css("width", this.widgetFullWidth);
                        $widget04.css("height", this.widgetFullHeight);
                    }
                    // find the children div but not the text div .
                    $widget04.find(this.selectorID("widget04avBackground")).find("div").not(this.selectorID("widget04avRateWrap")).css(this.star);
                    // star loop thingy
                    for (var i = 1; i < 6; i++) {
                        i <= this.floorNote ? this.fillFullStar(i, $) : this.fillEmptyStar(i, $);
                    }
                    $widget04.find(this.selectorID("widget04avImage")).attr("alt", this.floorNote + (this.floorNote > 1 ? " stars" : " star"));
                    var $image6 = $(this.selectorID("widget04avStars06"));
                    if (this.diffNote == 0) {
                    ...
                    // text code
                    var $rateWrap = $widget04.find(this.selectorID("widget04avBackground")).find(this.selectorID("widget04avRateWrap"));
                    $rateWrap.css(this.ratingCommunCss);
                    $rateWrap.find("span").css("font-size", "inherit");
                    $rateWrap.find(this.selectorID("widget04avRate")).html(this.textNote);
                    if (this.noteSur10) {
                        $rateWrap.css(this.ratingCss10);
                        $rateWrap.find(this.selectorID("widget04avRateOver")).html("10");
                    } else {
                        $rateWrap.css(this.ratingCss);
                        $rateWrap.find(this.selectorID("widget04avRateOver")).html("5");
                    }

                    if (addDimension) {
                        var dimensions = $widget04[0].getBoundingClientRect();
                ...
                addIframe: function (src) {
                    ...
                    var $widget04 = $(this.selectorID("widget04av"));
                    $widget04.css("cursor", "pointer");

                    $widget04.click(function () {
                        // FANCYBOX V3
                        $.fancybox.open({
                            src: src,
                            type: "iframe",
                ...
                mobileConfig: function (config) {
                    ...
                    if ($(window).width() < mobileWidth) {
                        ...
                        $widget04.css("transform", "scale(" + scale + ")");
    ...
    netreviewsWidget04Main = netreviewsWidget04.create();
    netreviewsWidget04Main.jQuery = jQuery.noConflict(true);
    netreviewsWidget04Main.jQuery(document).ready(function () {
        netreviewsWidget04Main.buildAll();
    });
} else {
